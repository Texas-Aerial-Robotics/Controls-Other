...
# Mess with packages 
apt-get update
apt-get purge -y whoopsie cups modemmanager unattended-upgrades deja-dup libreoffice-* gnome-mines gnome-sudoku gnome-mahjongg gnome-screensaver rhythmbox example-content aisleriot account-plugin-* brltty duplicity empathy thunderbird
